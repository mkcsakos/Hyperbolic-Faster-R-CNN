...
#SBATCH -o TrainingLogs/hyperbolic_faster_rcnn_hyper_adam_00005_cosine_reduce_out-%j          # send stdout to outfile
#SBATCH -e TrainingLogs/hyperbolic_faster_rcnn_hyper_adam_00005_cosine_reduce_error-%j          # send stderr to errfile
#SBATCH -J adam_00005_cosine_reduce
...
python -u tools/train.py /home/amakacs1/mmdetection/configs/faster_rcnn/hyperbolic_faster_rcnn/adam/hyperbolic_config_adam.py --work-dir /home/amakacs1/mmdetection/work_dirs/hyper_adam_00005_cosine_reduce/