...
#SBATCH -o TrainingLogs/hyperbolic_faster_rcnn_hyper_adam_81_dim_cosine_reduce_out-%j          # send stdout to outfile
#SBATCH -e TrainingLogs/hyperbolic_faster_rcnn_hyper_adam_81_dim_cosine_reduce_error-%j          # send stderr to errfile
#SBATCH -J 81_a
...
python -u tools/train.py /home/amakacs1/mmdetection/configs/faster_rcnn/hyperbolic_faster_rcnn/adam_81_dim/hyperbolic_config_adam_81_dim.py --work-dir /home/amakacs1/mmdetection/work_dirs/hyper_adam_81_dim_cosine_reduce/
