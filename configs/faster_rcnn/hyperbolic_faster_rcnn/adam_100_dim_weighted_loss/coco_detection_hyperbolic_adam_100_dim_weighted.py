...
data_root='../../../../projects/0/prjs0957/data/COCO/'
...
#     dict(type='ShiftScaleRotate', shift_limit=0.1, scale_limit=0.1, rotate_limit=10, p=0.5),
...
train_pipeline = [
    ...
    # dict(type='Albu', transforms=albu_train_transforms, keymap={'img': 'image', 'gt_bboxes': 'bboxes'}, skip_img_without_anno=True),
...
#         # # ann_file='annotations/image_info_test2017.json',
...
#     # ann_file=data_root + 'annotations/instances_val2017.json',
#     outfile_prefix='./work_dirs/coco_detection/test2'
# )
