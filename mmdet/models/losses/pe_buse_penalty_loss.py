...
class PeBusePenaltyLoss(nn.Module):
    def __init__(self, dimension, num_classes, prototype_path, penalty_option='dim', mult=1.0, loss_weight=1.0, epsilon=1e-6):
        super(PeBusePenaltyLoss, self).__init__()
